...
LOAD_NAME = "11_ResNet_invResB_ghostBlocks_small_pruning_6"
SAVE_NAME = "11_ResNet_invResB_ghostBlocks_small_6_pruned"
DEVICES = [0]
SEED = 0
PRUNING_RATE = 0.2
BATCH_SIZE = 128
...
def main(model):      
    ...
    checkpoint = torch.load("./saved_models/pruning/11/{}.ckpt".format(LOAD_NAME))

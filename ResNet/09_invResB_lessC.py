...
model.conv1 = DWSconv(3, 10, pointwise=True)
model.bn1 = torch.nn.BatchNorm2d(10)
model.maxpool = torch.nn.Identity()

#layer1
model.layer1[0] = invertedResidual(10, 64, 10, downsample=True)
...
model.layer4 = torch.nn.Sequential(
    ...
    invertedResidual(86, 512, 86),
    torch.nn.Conv2d(86, 512, kernel_size=1, stride=1, bias=False),
    torch.nn.BatchNorm2d(512),
    torch.nn.ReLU6(inplace=True),

    torch.nn.Conv2d(512, 10, kernel_size=1, stride=1, bias=False),
